...
.div.privacy-policy
  h1 隱私權政策
  p 歡迎您使用我們的服務！我們非常重視您的隱私權保護，特此說明自學2.0(以下簡稱本平台)的互助旗內容是完全公開的。使用本服務時，請您謹慎考慮哪些資訊是您願意公開於網路上。
  p 我們鼓勵您只分享您願意讓他人知道的信息。為了保護您的個人隱私，請不要在互助旗上放置任何敏感或個人身份信息。
  p 為了您的資料安全，本平台提供了資料下載備份的選項。您可以隨時下載您的互助旗資料，以便於自行管理和備份。
  h2 創用授權
  p
  ...
  h2 管理員權利
  p 若遇到特殊情況，例如用戶兩年以及未更新旗幟或是出現不雅語言等問題，自學2.0管理員保有移除互助旗之權利，但管理員仍需遵守創用授權，不得局部修改用戶之互助旗。
  h2 聯絡我們
